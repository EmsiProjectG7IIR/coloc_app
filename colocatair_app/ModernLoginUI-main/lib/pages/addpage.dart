          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                onSaved: (value) => offer.montant = double.parse(value!) as int?,
                validator: (value) {
                  if (value == null || value.isEmpty) {
              ...
              FormBuilderDateTimePicker(
                  ...
                  onSaved: (value) {
                    offer.dateCreation = value as DateTime?;
                  },
                ),
                ...
                FormBuilderDateTimePicker(
                  ...
                  onSaved: (value) {
                    offer.dateDebut = value as DateTime?;
                  },
                ),
                ...
                FormBuilderDateTimePicker(
                  ...
                  onSaved: (value) {
                    offer.dateFin = value as DateTime?;
                  },
                ),
